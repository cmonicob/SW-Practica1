...
urlpatterns = patterns('',
    ...
    url(r'^clients/(\w+)/edit$', clientEdit.as_view(), name='client_edit'),
#    url(r'^clients/(\w+)/delete$', clientDelete),
    ...
    url(r'^cardealers/(\w+)/orders/create$', carDealersOrderCreate.as_view(), name='order_create'),
...
#    url(r'^cardealers/(\w+)/delete$', carDealersDelete),
    ...
    url(r'^brands/create$', brandsCreate.as_view(), name='carDealer_create'),
